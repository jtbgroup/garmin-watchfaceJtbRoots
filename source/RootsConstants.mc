...
module RootsConstants {
	...
	const OPTION_ZONE_FLOORS_CLIMBED_VALUE = 8;
	const OPTION_ZONE_FLOORS_CLIMBED_BAR = 9;
	const OPTION_ZONE_STEPS_VALUE = 10;
	const OPTION_ZONE_STEPS_BAR = 11;
...
//	var HOUR_FORMAT_24 = 1;
	...
	const PROP_MODE_BATTERY="PROP_MODE_BATTERY";
